...
const Home = () => {
  ...
  return (
            ...
            <div className="flex-none">
              ...
              <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                  ...
                  <li><a>Settings</a></li>
                  <li><a onClick={handleLogin}>Logout</a></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div className=''>
        ...
        <div className='grid justify-items-center grid-cols-1 md:grid-cols-3 gap-4 py-5 content-center'>
            
            <div className="card w-80 bg-accent shadow-xl">
                <figure><img src="https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/f820e398-3050-438b-91a9-e985898def17/spark-shoes-zPVQHZ.png" alt="Shoes" /></figure>
                <div className="card-body ">
            ...
            <div className="card w-80 bg-accent shadow-xl">
                <figure><img src="https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/8a611231-947a-4c84-8de5-2202e2fb12f5/air-max-97-og-shoes-pKxPsp.png" alt="Shoes" /></figure>
                <div className="card-body">
                    <h2 className="card-title">Shoes!</h2>
                    <p>If a dog chews shoes whose shoes does he choose?</p>
                    <div className="card-actions justify-end">
        ...
        <footer className="footer footer-center p-10 bg-accent text-primary-content relative inset-x-0 bottom-0">
            <aside>
